    ...
    return (
        <div className="animate-fade-in p-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 mb-8">
                <h3 className="text-lg font-bold text-[#213448] mb-4">Onboard New Company</h3>
                <form onSubmit={handleCreateCompany} className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <button 
                        type="submit" 
                        disabled={creating}
                        className="btn-premium bg-[#213448] text-white font-bold p-3 rounded-xl hover:bg-[#213448] w-full md:w-auto min-w-[150px]"
                    >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                <div className="p-5 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                    ...
                    <span className="bg-[#213448] text-white text-xs font-bold px-3 py-1 rounded-full">
                            ...
                            <tbody>
                                {companies.map((company) => (
                                    <tr key={company._id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="p-4 font-mono text-sm text-[#213448] font-bold">
                                            {company.slug}
                                        </td>
